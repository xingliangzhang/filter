...
public class CommentFilter1 implements Filter {
	 ...
	 */
	public void destroy() {
		System.out.println("filter1的destroy方法调用了");
	}
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
		...
		System.out.println("filter1 doFilter方法执行完毕。。。。");
	...
	public void init(FilterConfig arg0) throws ServletException {
		System.out.println("filter1的init方法被调用了");
	}

	public CommentFilter1() {
		System.out.println("fileter1的构造器实例");
	}
